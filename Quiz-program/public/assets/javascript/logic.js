...

{
	...
	document.write('<div class="btn-group" data-toggle="buttons"><label class="btn btn-primary"><input type="radio" name="'+name+'" autocomplete="off" value="T">True</label><label class="btn btn-primary"><input type="radio" name="'+name+'" autocomplete="off" value="F">False</label></div>');
